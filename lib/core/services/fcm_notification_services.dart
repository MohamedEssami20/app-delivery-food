...
import 'local_notifcations_service.dart';
import 'notificaction_service.dart';
...
class FcmNotificationService implements NotificationService {
  ...
  Future<void> init() async {
    ...
    if (token != null) {
      ...
      await GetIt.instance.get<UserRepo>().updateUserToken(token);
    ...
    _fcm.onTokenRefresh.listen((String newToken) async {
      ...
      await GetIt.instance.get<UserRepo>().updateUserToken(newToken);
    });
